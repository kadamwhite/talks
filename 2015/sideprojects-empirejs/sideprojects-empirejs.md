...
![Venn Diagram showing "work problems" and "fun problems" largely overlapping, with "fun" being a much larger circle than "work", with a Google Cardboard VR headset in the "fun" category (outside of work) and the JIRA logo inside the "work" category (outside of fun)](images/work-problems-v-fun-problems-w-jira.png)
