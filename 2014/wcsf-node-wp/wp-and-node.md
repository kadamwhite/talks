...
<div class="full">
[![Tapete Verde, by Radamés Manosso](images/tapete-verde-radames-manosso.jpg)](https://www.flickr.com/photos/radamesm/6364307701)
</div>

Note: In January my team started building an application for a new business unit for a fortune-50 company. As it was a new business unit, it was a fresh build: there would be no integration with the parent company's existing systems.
...
## Changing the way we think about WP
...
Note: There are a lot of individual components within WordPress that you may or may not need
...
[wordpress-rest-api](https://github.com/kadamwhite/wordpress-rest-api) on Github
...
1. Route identifies what content is needed
2. Content Service is called by route, wraps NPM module
3. `wordpress-rest-api` structures & sends the query
4. API receives response
5. WP plugin customizes response to our needs
6. API returns data
7. Page is rendered
